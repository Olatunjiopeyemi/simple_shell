...
/**
 * replace_vars - function thst replaces vars
 * @info: info struct
 * Return: 1 or 0
 */
...
/**
 * is_chain - checks if char in buffer is a delimeter
 * @info: info struct
 * @buf: buffer
 * @p: address of buf
 * Return: 1 or 0
...
/**
 * replace_alias - function that replaces a string
 * @info: info struct
 * Return: 1 or 0
 */
